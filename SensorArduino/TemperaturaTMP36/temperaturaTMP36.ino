...
void setup() {
   ...
   lcd.print("TemperaturaTMP36");//Imprimimos en pantalla 
...
void loop() {
   ...
   //float ValLM35=analogRead(A0);//Lectura del sensor LM35
   float ValTMP36=analogRead(A0);//Lectura del sensor TMP36 en el pin analogo 0
   //Temperaturas TMP36
   float centigrados=ValTMP36*0.488-50;//temperatura °C
